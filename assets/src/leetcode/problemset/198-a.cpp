...
class Solution {
public:
  int helper(int emp, int exc) {
    if(emp < exc) return 0;
    int t = emp / exc;
    return t + helper(t + emp % exc, exc);
  }
...
#ifdef DEBUG
  freopen("198-a.in", "r", stdin);
#endif

  Solution a;
  cout<<a.numWaterBottles(9, 3)<<endl;
  cout<<a.numWaterBottles(15, 4)<<endl;
  cout<<a.numWaterBottles(5, 5)<<endl;
  cout<<a.numWaterBottles(2, 3)<<endl;
