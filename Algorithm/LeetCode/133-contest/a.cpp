...
public:
  int twoCitySchedCost(vector<vector<int>> &costs) {
    sort(costs.begin(), costs.end(), [&](VI &a, VI &b) {
      if (a[1] < b[1])
        return true;
      else if (a[1] > b[1])
        return false;
    ...
    int res = 0, acnt = 0, bcnt = 0, len = costs.size();
...
// freopen("a.in", "r", stdin);
  ...
  VVI t{{259, 770}, {448, 54}, {926, 667}, {184, 139}, {840, 118}, {577, 469}};
  Solution a;
  PRLN(a.twoCitySchedCost(t));
