...
#ifdef DEBUG
  freopen("template_test.in", "r", stdin);
#endif

  BNF a("123");
  PR1(a);
  PR2(BNF("0123"), BNF("123.0"));
  PR2(BNF("0123.000"), BNF("00123.0"));
  PR2(BNF("000.000"), BNF(".000"));
  PR2(BNF("0"), BNF("0001000"));
  a = "0.2230";
  PR1(a);
  BNF a1("000.0100"), a2("1.9000");
  PR3(a1, a2, a1 + a2);
  PR4(a1 < a2, a1 > a2, a1 <= a2, a1 >= a2);
  PR1(a2 - a1);
  PR1(a1 * a2);
  BNF a3("0.020"), a4("2");
  PR1(a3 * a4);
